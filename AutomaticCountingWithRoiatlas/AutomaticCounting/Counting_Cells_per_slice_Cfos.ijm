...
image_input ="X:/Users/Members/Yael_Kashash/ABBA for trial_BMR4/tifs/Cfos/43_BMR4_Slide2_08.tif";
scale = 648.4;
StainCell = "Cfos";
roi_input ="X:/Users/Members/Yael_Kashash/ABBA for trial_BMR4/tifs/Roi_all_image/43_BMR4_Slide2_08.zip";
roi_atlas = "X:/Users/Members/Yael_Kashash/ABBA for trial_BMR4/tifs/ROI_From_Atlas/RoiSet43_BMR4_Slide2_08.zip";
...
//roi_all = "X:/Users/Members/Yael_Kashash/ABBA for trial_BMR4/tifs/Roi_all_image/RoisAll/4p16_brain_old1_plate1_1_2.roi"
...
//print(nlabels);
count=0;
//creat array to delete smaller regions
array_delete=newArray(0);
...
for (vr1 = nAtlas; vr1 < (nTotal-1); vr1++){
  ...
  if(area_cfos > 100){
   ...
   if (selectionType > -1 ){// if it is overlapped
	...
	array_delete = Array.concat(array_delete,count);
}
}
// print(count);
 count = count + 1;
...
//delete array with small cfos area
roiManager("select", array_delete);
roiManager("delete");
//
roiManager("Set Line Width", 2);
run("Flatten");
saveAs("Tiff", outputImages + name_file + "All.tif" );
//save again the zip with new labels selection
roiManager("save", roi_input);
