...
def main():
   ...
   app.geometry("500x500")  # Set the initial size of the window
   ...
   ok_button.grid(row=9, column=0, columnspan=2, pady=30)
   ...
   checkbutton3.grid(row=7, column=1, sticky='w',pady =20)
   checkbutton2.grid(row=8, column=1, sticky='w',pady =20)
